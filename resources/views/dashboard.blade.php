                ...
                <div class="p-6 text-gray-900">
                    <div class="max-w-md mx-auto">
                        ...
                        <form id="feedbackForm" class="space-y-6">
                            ...
                            <div>
                                <button type="submit" id="submitButton" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-indigo-500">
